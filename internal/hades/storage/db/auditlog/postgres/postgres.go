// Package postgres provides the PostgreSQL implementation of auditlog.Storage.
package postgres
...
// AuditLogStorage implements auditlog.Storage against PostgreSQL.
type AuditLogStorage struct {
	pool *pgxpool.Pool
}

// New creates an AuditLogStorage backed by a connection pool.
