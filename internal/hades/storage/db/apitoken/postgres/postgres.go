// Package postgres provides the PostgreSQL implementation of apitoken.Storage.
package postgres
...
// APITokenStorage implements apitoken.Storage against PostgreSQL.
type APITokenStorage struct {
	pool *pgxpool.Pool
}

// New creates an APITokenStorage backed by a connection pool.
