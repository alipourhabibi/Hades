// Package postgres provides the PostgreSQL implementation of passwordreset.Storage.
package postgres
...
// PasswordResetStorage implements passwordreset.Storage against PostgreSQL.
type PasswordResetStorage struct {
	pool *pgxpool.Pool
}

// New creates a PasswordResetStorage backed by a connection pool.
