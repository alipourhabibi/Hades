// Package postgres provides the PostgreSQL implementation of emailverification.Storage.
package postgres
...
// EmailVerificationStorage implements emailverification.Storage against PostgreSQL.
type EmailVerificationStorage struct {
	pool *pgxpool.Pool
}

// New creates an EmailVerificationStorage backed by a connection pool.
