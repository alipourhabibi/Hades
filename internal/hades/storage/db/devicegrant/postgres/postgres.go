// Package postgres provides the PostgreSQL implementation of devicegrant.Storage.
package postgres
...
// DeviceGrantStorage implements devicegrant.Storage against PostgreSQL.
type DeviceGrantStorage struct {
	pool *pgxpool.Pool
}

// New creates a DeviceGrantStorage backed by a connection pool.
