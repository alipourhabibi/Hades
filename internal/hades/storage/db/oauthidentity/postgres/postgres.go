// Package postgres provides the PostgreSQL implementation of oauthidentity.Storage.
package postgres
...
// OAuthIdentityStorage implements oauthidentity.Storage against PostgreSQL.
type OAuthIdentityStorage struct {
	pool *pgxpool.Pool
}

// New creates an OAuthIdentityStorage backed by a connection pool.
