...
const (
	...
	AuthenticationServiceName = "hades.api.auth.v1.AuthenticationService"
)
...
const (
	...
	// Login RPC.
	AuthenticationServiceLoginProcedure = "/hades.api.auth.v1.AuthenticationService/Login"
	// AuthenticationServiceRegisterProcedure is the fully-qualified name of the AuthenticationService's
	// Register RPC.
	AuthenticationServiceRegisterProcedure = "/hades.api.auth.v1.AuthenticationService/Register"
	// AuthenticationServiceSigninProcedure is the fully-qualified name of the AuthenticationService's
	// Signin RPC.
	AuthenticationServiceSigninProcedure = "/hades.api.auth.v1.AuthenticationService/Signin"
	// AuthenticationServiceLogoutProcedure is the fully-qualified name of the AuthenticationService's
	// Logout RPC.
	AuthenticationServiceLogoutProcedure = "/hades.api.auth.v1.AuthenticationService/Logout"
	// AuthenticationServiceVerifyEmailProcedure is the fully-qualified name of the
	// AuthenticationService's VerifyEmail RPC.
	AuthenticationServiceVerifyEmailProcedure = "/hades.api.auth.v1.AuthenticationService/VerifyEmail"
	...
	AuthenticationServiceResendVerificationEmailProcedure = "/hades.api.auth.v1.AuthenticationService/ResendVerificationEmail"
	...
	AuthenticationServiceRequestPasswordResetProcedure = "/hades.api.auth.v1.AuthenticationService/RequestPasswordReset"
	// AuthenticationServiceResetPasswordProcedure is the fully-qualified name of the
	// AuthenticationService's ResetPassword RPC.
	AuthenticationServiceResetPasswordProcedure = "/hades.api.auth.v1.AuthenticationService/ResetPassword"
	...
	AuthenticationServiceChangePasswordProcedure = "/hades.api.auth.v1.AuthenticationService/ChangePassword"
)

// AuthenticationServiceClient is a client for the hades.api.auth.v1.AuthenticationService service.
...
// hades.api.auth.v1.AuthenticationService service. By default, it uses the Connect protocol with
...
func NewAuthenticationServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) AuthenticationServiceClient {
	...
	authenticationServiceMethods := v1.File_api_auth_v1_auth_proto.Services().ByName("AuthenticationService").Methods()
...
// Login calls hades.api.auth.v1.AuthenticationService.Login.
...
// Register calls hades.api.auth.v1.AuthenticationService.Register.
...
// Signin calls hades.api.auth.v1.AuthenticationService.Signin.
...
// Logout calls hades.api.auth.v1.AuthenticationService.Logout.
...
// VerifyEmail calls hades.api.auth.v1.AuthenticationService.VerifyEmail.
...
// ResendVerificationEmail calls hades.api.auth.v1.AuthenticationService.ResendVerificationEmail.
...
// RequestPasswordReset calls hades.api.auth.v1.AuthenticationService.RequestPasswordReset.
...
// ResetPassword calls hades.api.auth.v1.AuthenticationService.ResetPassword.
...
// ChangePassword calls hades.api.auth.v1.AuthenticationService.ChangePassword.
...
// AuthenticationServiceHandler is an implementation of the hades.api.auth.v1.AuthenticationService
// service.
...
func NewAuthenticationServiceHandler(svc AuthenticationServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/hades.api.auth.v1.AuthenticationService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedAuthenticationServiceHandler) Login(context.Context, *connect.Request[v1.LoginRequest]) (*connect.Response[v1.LoginResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("hades.api.auth.v1.AuthenticationService.Login is not implemented"))
}
...
func (UnimplementedAuthenticationServiceHandler) Register(context.Context, *connect.Request[v1.RegisterRequest]) (*connect.Response[v1.RegisterResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("hades.api.auth.v1.AuthenticationService.Register is not implemented"))
}
...
func (UnimplementedAuthenticationServiceHandler) Signin(context.Context, *connect.Request[v1.SigninRequest]) (*connect.Response[v1.SigninResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("hades.api.auth.v1.AuthenticationService.Signin is not implemented"))
}
...
func (UnimplementedAuthenticationServiceHandler) Logout(context.Context, *connect.Request[v1.LogoutRequest]) (*connect.Response[v1.LogoutResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("hades.api.auth.v1.AuthenticationService.Logout is not implemented"))
}
...
func (UnimplementedAuthenticationServiceHandler) VerifyEmail(context.Context, *connect.Request[v1.VerifyEmailRequest]) (*connect.Response[v1.VerifyEmailResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("hades.api.auth.v1.AuthenticationService.VerifyEmail is not implemented"))
}
...
func (UnimplementedAuthenticationServiceHandler) ResendVerificationEmail(context.Context, *connect.Request[v1.ResendVerificationEmailRequest]) (*connect.Response[v1.ResendVerificationEmailResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("hades.api.auth.v1.AuthenticationService.ResendVerificationEmail is not implemented"))
}
...
func (UnimplementedAuthenticationServiceHandler) RequestPasswordReset(context.Context, *connect.Request[v1.RequestPasswordResetRequest]) (*connect.Response[v1.RequestPasswordResetResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("hades.api.auth.v1.AuthenticationService.RequestPasswordReset is not implemented"))
}
...
func (UnimplementedAuthenticationServiceHandler) ResetPassword(context.Context, *connect.Request[v1.ResetPasswordRequest]) (*connect.Response[v1.ResetPasswordResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("hades.api.auth.v1.AuthenticationService.ResetPassword is not implemented"))
}
...
func (UnimplementedAuthenticationServiceHandler) ChangePassword(context.Context, *connect.Request[v1.ChangePasswordRequest]) (*connect.Response[v1.ChangePasswordResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("hades.api.auth.v1.AuthenticationService.ChangePassword is not implemented"))
}
