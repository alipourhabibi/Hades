...
const file_api_auth_v1_auth_proto_rawDesc = "" +
	"\n" +
	"\x16api/auth/v1/auth.proto\x12\x11hades.api.auth.v1\x1a\x1bbuf/validate/validate.proto\"u\n" +
	"\fLoginRequest\x12\"\n" +
	...
	"\x16ChangePasswordResponse2\xfb\x06\n" +
	"\x15AuthenticationService\x12J\n" +
	"\x05Login\x12\x1f.hades.api.auth.v1.LoginRequest\x1a .hades.api.auth.v1.LoginResponse\x12S\n" +
	"\bRegister\x12\".hades.api.auth.v1.RegisterRequest\x1a#.hades.api.auth.v1.RegisterResponse\x12M\n" +
	"\x06Signin\x12 .hades.api.auth.v1.SigninRequest\x1a!.hades.api.auth.v1.SigninResponse\x12M\n" +
	"\x06Logout\x12 .hades.api.auth.v1.LogoutRequest\x1a!.hades.api.auth.v1.LogoutResponse\x12\\\n" +
	"\vVerifyEmail\x12%.hades.api.auth.v1.VerifyEmailRequest\x1a&.hades.api.auth.v1.VerifyEmailResponse\x12\x80\x01\n" +
	"\x17ResendVerificationEmail\x121.hades.api.auth.v1.ResendVerificationEmailRequest\x1a2.hades.api.auth.v1.ResendVerificationEmailResponse\x12w\n" +
	"\x14RequestPasswordReset\x12..hades.api.auth.v1.RequestPasswordResetRequest\x1a/.hades.api.auth.v1.RequestPasswordResetResponse\x12b\n" +
	"\rResetPassword\x12'.hades.api.auth.v1.ResetPasswordRequest\x1a(.hades.api.auth.v1.ResetPasswordResponse\x12e\n" +
	"\x0eChangePassword\x12(.hades.api.auth.v1.ChangePasswordRequest\x1a).hades.api.auth.v1.ChangePasswordResponseB\xc4\x01\n" +
	"\x15com.hades.api.auth.v1B\tAuthProtoP\x01Z9github.com/alipourhabibi/Hades/api/gen/api/auth/v1;authv1\xa2\x02\x03HAA\xaa\x02\x11Hades.Api.Auth.V1\xca\x02\x11Hades\\Api\\Auth\\V1\xe2\x02\x1dHades\\Api\\Auth\\V1\\GPBMetadata\xea\x02\x14Hades::Api::Auth::V1b\x06proto3"
...
var file_api_auth_v1_auth_proto_goTypes = []any{
	(*LoginRequest)(nil),                    // 0: hades.api.auth.v1.LoginRequest
	(*LoginResponse)(nil),                   // 1: hades.api.auth.v1.LoginResponse
	(*RegisterRequest)(nil),                 // 2: hades.api.auth.v1.RegisterRequest
	(*RegisterResponse)(nil),                // 3: hades.api.auth.v1.RegisterResponse
	(*SigninRequest)(nil),                   // 4: hades.api.auth.v1.SigninRequest
	(*SigninResponse)(nil),                  // 5: hades.api.auth.v1.SigninResponse
	(*LogoutRequest)(nil),                   // 6: hades.api.auth.v1.LogoutRequest
	(*LogoutResponse)(nil),                  // 7: hades.api.auth.v1.LogoutResponse
	(*VerifyEmailRequest)(nil),              // 8: hades.api.auth.v1.VerifyEmailRequest
	(*VerifyEmailResponse)(nil),             // 9: hades.api.auth.v1.VerifyEmailResponse
	(*ResendVerificationEmailRequest)(nil),  // 10: hades.api.auth.v1.ResendVerificationEmailRequest
	(*ResendVerificationEmailResponse)(nil), // 11: hades.api.auth.v1.ResendVerificationEmailResponse
	(*RequestPasswordResetRequest)(nil),     // 12: hades.api.auth.v1.RequestPasswordResetRequest
	(*RequestPasswordResetResponse)(nil),    // 13: hades.api.auth.v1.RequestPasswordResetResponse
	(*ResetPasswordRequest)(nil),            // 14: hades.api.auth.v1.ResetPasswordRequest
	(*ResetPasswordResponse)(nil),           // 15: hades.api.auth.v1.ResetPasswordResponse
	(*ChangePasswordRequest)(nil),           // 16: hades.api.auth.v1.ChangePasswordRequest
	(*ChangePasswordResponse)(nil),          // 17: hades.api.auth.v1.ChangePasswordResponse
}
var file_api_auth_v1_auth_proto_depIdxs = []int32{
	0,  // 0: hades.api.auth.v1.AuthenticationService.Login:input_type -> hades.api.auth.v1.LoginRequest
	2,  // 1: hades.api.auth.v1.AuthenticationService.Register:input_type -> hades.api.auth.v1.RegisterRequest
	4,  // 2: hades.api.auth.v1.AuthenticationService.Signin:input_type -> hades.api.auth.v1.SigninRequest
	6,  // 3: hades.api.auth.v1.AuthenticationService.Logout:input_type -> hades.api.auth.v1.LogoutRequest
	8,  // 4: hades.api.auth.v1.AuthenticationService.VerifyEmail:input_type -> hades.api.auth.v1.VerifyEmailRequest
	10, // 5: hades.api.auth.v1.AuthenticationService.ResendVerificationEmail:input_type -> hades.api.auth.v1.ResendVerificationEmailRequest
	12, // 6: hades.api.auth.v1.AuthenticationService.RequestPasswordReset:input_type -> hades.api.auth.v1.RequestPasswordResetRequest
	14, // 7: hades.api.auth.v1.AuthenticationService.ResetPassword:input_type -> hades.api.auth.v1.ResetPasswordRequest
	16, // 8: hades.api.auth.v1.AuthenticationService.ChangePassword:input_type -> hades.api.auth.v1.ChangePasswordRequest
	1,  // 9: hades.api.auth.v1.AuthenticationService.Login:output_type -> hades.api.auth.v1.LoginResponse
	3,  // 10: hades.api.auth.v1.AuthenticationService.Register:output_type -> hades.api.auth.v1.RegisterResponse
	5,  // 11: hades.api.auth.v1.AuthenticationService.Signin:output_type -> hades.api.auth.v1.SigninResponse
	7,  // 12: hades.api.auth.v1.AuthenticationService.Logout:output_type -> hades.api.auth.v1.LogoutResponse
	9,  // 13: hades.api.auth.v1.AuthenticationService.VerifyEmail:output_type -> hades.api.auth.v1.VerifyEmailResponse
	11, // 14: hades.api.auth.v1.AuthenticationService.ResendVerificationEmail:output_type -> hades.api.auth.v1.ResendVerificationEmailResponse
	13, // 15: hades.api.auth.v1.AuthenticationService.RequestPasswordReset:output_type -> hades.api.auth.v1.RequestPasswordResetResponse
	15, // 16: hades.api.auth.v1.AuthenticationService.ResetPassword:output_type -> hades.api.auth.v1.ResetPasswordResponse
	17, // 17: hades.api.auth.v1.AuthenticationService.ChangePassword:output_type -> hades.api.auth.v1.ChangePasswordResponse
