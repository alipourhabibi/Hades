...
const (
	...
	NotificationServiceName = "hades.api.identity.v1.NotificationService"
)
...
const (
	...
	NotificationServiceListNotificationsProcedure = "/hades.api.identity.v1.NotificationService/ListNotifications"
	...
	NotificationServiceMarkNotificationReadProcedure = "/hades.api.identity.v1.NotificationService/MarkNotificationRead"
)

// NotificationServiceClient is a client for the hades.api.identity.v1.NotificationService service.
...
// hades.api.identity.v1.NotificationService service. By default, it uses the Connect protocol with
...
func NewNotificationServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) NotificationServiceClient {
	...
	notificationServiceMethods := v1.File_api_identity_v1_notification_proto.Services().ByName("NotificationService").Methods()
...
// ListNotifications calls hades.api.identity.v1.NotificationService.ListNotifications.
...
// MarkNotificationRead calls hades.api.identity.v1.NotificationService.MarkNotificationRead.
...
// NotificationServiceHandler is an implementation of the hades.api.identity.v1.NotificationService
// service.
...
func NewNotificationServiceHandler(svc NotificationServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/hades.api.identity.v1.NotificationService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedNotificationServiceHandler) ListNotifications(context.Context, *connect.Request[v1.ListNotificationsRequest]) (*connect.Response[v1.ListNotificationsResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("hades.api.identity.v1.NotificationService.ListNotifications is not implemented"))
}
...
func (UnimplementedNotificationServiceHandler) MarkNotificationRead(context.Context, *connect.Request[v1.MarkNotificationReadRequest]) (*connect.Response[v1.MarkNotificationReadResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("hades.api.identity.v1.NotificationService.MarkNotificationRead is not implemented"))
}
