...
const (
	...
	UserServiceName = "hades.api.identity.v1.UserService"
)
...
const (
	...
	UserServiceCreateUserProcedure = "/hades.api.identity.v1.UserService/CreateUser"
	// UserServiceGetUserProcedure is the fully-qualified name of the UserService's GetUser RPC.
	UserServiceGetUserProcedure = "/hades.api.identity.v1.UserService/GetUser"
	// UserServiceListUsersProcedure is the fully-qualified name of the UserService's ListUsers RPC.
	UserServiceListUsersProcedure = "/hades.api.identity.v1.UserService/ListUsers"
	// UserServiceUpdateUserProcedure is the fully-qualified name of the UserService's UpdateUser RPC.
	UserServiceUpdateUserProcedure = "/hades.api.identity.v1.UserService/UpdateUser"
)
...
// NewUserServiceClient constructs a client for the hades.api.identity.v1.UserService service. By
...
func NewUserServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) UserServiceClient {
	...
	userServiceMethods := v1.File_api_identity_v1_user_proto.Services().ByName("UserService").Methods()
...
// CreateUser calls hades.api.identity.v1.UserService.CreateUser.
...
// GetUser calls hades.api.identity.v1.UserService.GetUser.
...
// ListUsers calls hades.api.identity.v1.UserService.ListUsers.
...
// UpdateUser calls hades.api.identity.v1.UserService.UpdateUser.
...
func NewUserServiceHandler(svc UserServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/hades.api.identity.v1.UserService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedUserServiceHandler) CreateUser(context.Context, *connect.Request[v1.CreateUserRequest]) (*connect.Response[v1.CreateUserResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("hades.api.identity.v1.UserService.CreateUser is not implemented"))
}
...
func (UnimplementedUserServiceHandler) GetUser(context.Context, *connect.Request[v1.GetUserRequest]) (*connect.Response[v1.GetUserResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("hades.api.identity.v1.UserService.GetUser is not implemented"))
}
...
func (UnimplementedUserServiceHandler) ListUsers(context.Context, *connect.Request[v1.ListUsersRequest]) (*connect.Response[v1.ListUsersResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("hades.api.identity.v1.UserService.ListUsers is not implemented"))
}
...
func (UnimplementedUserServiceHandler) UpdateUser(context.Context, *connect.Request[v1.UpdateUserRequest]) (*connect.Response[v1.UpdateUserResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("hades.api.identity.v1.UserService.UpdateUser is not implemented"))
}
