...
const (
	...
	OrgServiceName = "hades.api.identity.v1.OrgService"
)
...
// NewOrgServiceClient constructs a client for the hades.api.identity.v1.OrgService service. By
...
func NewOrgServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) OrgServiceClient {
	...
	orgServiceMethods := v1.File_api_identity_v1_org_proto.Services().ByName("OrgService").Methods()
...
// GetOrg calls hades.api.identity.v1.OrgService.GetOrg.
...
// ListOrgMembers calls hades.api.identity.v1.OrgService.ListOrgMembers.
...
// CreateOrg calls hades.api.identity.v1.OrgService.CreateOrg.
...
// UpdateOrg calls hades.api.identity.v1.OrgService.UpdateOrg.
...
// AddOrgMember calls hades.api.identity.v1.OrgService.AddOrgMember.
...
// RemoveOrgMember calls hades.api.identity.v1.OrgService.RemoveOrgMember.
...
// ListOrganizations calls hades.api.identity.v1.OrgService.ListOrganizations.
...
// GetUserOrgs calls hades.api.identity.v1.OrgService.GetUserOrgs.
...
func NewOrgServiceHandler(svc OrgServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/hades.api.identity.v1.OrgService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedOrgServiceHandler) GetOrg(context.Context, *connect.Request[v1.GetOrgRequest]) (*connect.Response[v1.GetOrgResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("hades.api.identity.v1.OrgService.GetOrg is not implemented"))
}
...
func (UnimplementedOrgServiceHandler) ListOrgMembers(context.Context, *connect.Request[v1.ListOrgMembersRequest]) (*connect.Response[v1.ListOrgMembersResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("hades.api.identity.v1.OrgService.ListOrgMembers is not implemented"))
}
...
func (UnimplementedOrgServiceHandler) CreateOrg(context.Context, *connect.Request[v1.CreateOrgRequest]) (*connect.Response[v1.CreateOrgResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("hades.api.identity.v1.OrgService.CreateOrg is not implemented"))
}
...
func (UnimplementedOrgServiceHandler) UpdateOrg(context.Context, *connect.Request[v1.UpdateOrgRequest]) (*connect.Response[v1.UpdateOrgResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("hades.api.identity.v1.OrgService.UpdateOrg is not implemented"))
}
...
func (UnimplementedOrgServiceHandler) AddOrgMember(context.Context, *connect.Request[v1.AddOrgMemberRequest]) (*connect.Response[v1.AddOrgMemberResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("hades.api.identity.v1.OrgService.AddOrgMember is not implemented"))
}
...
func (UnimplementedOrgServiceHandler) RemoveOrgMember(context.Context, *connect.Request[v1.RemoveOrgMemberRequest]) (*connect.Response[v1.RemoveOrgMemberResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("hades.api.identity.v1.OrgService.RemoveOrgMember is not implemented"))
}
...
func (UnimplementedOrgServiceHandler) ListOrganizations(context.Context, *connect.Request[v1.ListOrganizationsRequest]) (*connect.Response[v1.ListOrganizationsResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("hades.api.identity.v1.OrgService.ListOrganizations is not implemented"))
}
...
func (UnimplementedOrgServiceHandler) GetUserOrgs(context.Context, *connect.Request[v1.GetUserOrgsRequest]) (*connect.Response[v1.GetUserOrgsResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("hades.api.identity.v1.OrgService.GetUserOrgs is not implemented"))
}
